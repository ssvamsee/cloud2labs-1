    ...
    <div>
      <div id="contact">
        <div className="container">
                  ...
                  <div className="col-md-6">
                    <div className="form-group">
                      <input
                        ...
                        name="email"
                        className="form-control"
                        placeholder="Please Enter Your Email To Contact Back"
                        required
                        onChange={handleChange}
                      />
                      <p className="help-block text-danger"></p>
          ...
          <div className="col-md-3 col-md-offset-1 contact-info" data-aos="fade-left">
      ...
      <div id="footer">
        <div className="container text-center">
          <p>
            &copy; 2024 Cloud 2 Labs. Design by{" "}
            <a href="http://www.siddamvamsee.in" rel="nofollow">
              Siddam Vamsee
            </a>
          </p>
        </div>
